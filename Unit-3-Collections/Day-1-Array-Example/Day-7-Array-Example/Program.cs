...
class Program
    {
         ...
         *     rather than as we get each numbery
         *
        ...
        static void Main(string[] args)
        {
            ...
            // A constant cannot be changed once it assigned a value
            ...
            // Use a for-loop
            // for(int i=0; i<size-of-array; i++) - use i as index into the array inside the loop

            // Set up a loop to get ARRAY_SIZE numbers, one at a time or responses indicating the user is done
            for (int i = 0; i < ARRAY_SIZE; i++) // instead of ARRAY_SIZE theNumber.Length is OK too
            {
            ...
            } // End of for-loop break send us to line after this
            ...
            for (int i = 0; i < numberEntered; i++)
            {
                ...
                //
                // % - modulus operator - returns the remainder after an interger
                // Use % operator when you want to know if something is evenly divisible by something else
                // 
                //      6 % 2 - return 0
                //      7 % 2 - return 1
                //      101 % 33 - return - 2 (100 / 33 - 3 with remainder 2 (99 + 2)
                //
                // If you divie a number by 2 and remainder is 0, it's even
        ...
        static bool moreInput()
        {
            ...
            bool   getInput      = true;   // Control the user interaction loop (do-while loop)
            ...
            //
            // We use a do-while loop because we need to ask the user at least once if they have any input 
            ...
            do
            {
                ...
                if (firstChar == "Y")
                {
                    getInput = false;       // Done getting input - set loop control variable to false - end the loop
        ...
        static double GetANumber()
        {
            ...
            do  // do loop is used so we ask the user for a number at least once
            {
                ...
                //
                // You put that might cause an Exception in a try block of code
                ...
                catch (FormatException exceptionBlock) // Handle a FormatException in previous try block
                {
                    ...
                    Console.WriteLine(exceptionBlock.Message); // Display the system message for the error from the exception object
